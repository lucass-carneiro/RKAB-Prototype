...
struct Params1DBurgers
    ...
    function Params1DBurgers(config_file)
        config_data = YAML.load_file(config_file)
        
        domain_start = config_data["1d_burgers_params"]["domain"]["start"]
        domain_end = config_data["1d_burgers_params"]["domain"]["end"]
        domain_cells = config_data["1d_burgers_params"]["domain"]["cells"]

        time_final = config_data["1d_burgers_params"]["time"]["final"]
        time_cfl = config_data["1d_burgers_params"]["time"]["cfl"]
        time_method = config_data["1d_burgers_params"]["time"]["method"]

        output_file = config_data["1d_burgers_params"]["output"]["name"]
        output_every = config_data["1d_burgers_params"]["output"]["every"]
